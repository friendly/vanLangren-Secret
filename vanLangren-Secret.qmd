...
![Page 8 of *La Verdadera Longitud por Mar y Tierra* (1644): the printed cipher, exactly as van Langren's readers first saw it. _Source_: Courtesy of The Newberry Library, Chicago. Ayer folio QB225 .L36 1644.](images/verdadera-cipher-Newberry-bw.png){#fig-cipher-page width="80%"}
...
[John Snow's cholera map](https://friendly.github.io/HistData/reference/Snow.html)
and [Minard's March on Moscow](https://friendly.github.io/HistData/reference/Minard.html).
...
[Pareto Principle](https://en.wikipedia.org/wiki/Pareto_principle)) of data graphics says
...
![Cédric Scherer's `ggplot2` version of van Langren's graph, #30DayChartChallenge 2021, Day 3: Historical. _Source_: Cédric Scherer, [github.com/z3tt/30DayChartChallenge2021](https://github.com/z3tt/30DayChartChallenge2021/tree/main/03_historical).](images/03_historical.png){#fig-scherer}
