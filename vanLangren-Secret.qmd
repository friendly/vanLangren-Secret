...
What interested us most was *why* van Langren showed the earlier estimates in what would be the **first graphical display of quantitative data**, a 1D dot plot, rather than in the table anyone else at the time would have used. We always ask:

> **What was he thinking?**

Our answer was that only a dot plot would let the King **see** what van Langren wanted him to see:
all previous methods[^methods] were so variable as to be useless for navigation at sea.
...
He never said what the fix was. On page 8 of *La Verdadera* he printed it anyway---but in cipher, promising to reveal the plaintext after suitable compensation. Except for the puzzle, the [text of *La Verdadera*](https://www.datavis.ca/gallery/langren/verdadera.pdf) reads like a modern grant application.
We reproduced the ciphertext in [our supplementary materials](https://www.datavis.ca/gallery/langren/), posed a few questions about what kind of cipher it might be, and moved on.

Not quite right away. In 2009 and 2010 I tracked down a handful of codebreakers---a few retired from the CIA, a couple from NASA---who I thought might enjoy a historical puzzle. A few gave it a real try. Van Langren beat them all.
...
It contains 204 of those space-separated groups, nearly all of them four to eight characters long, no group repeating often enough to be a common word in any language. Take a minute and look at it before reading on---this is exactly what stared back at van Langren's readers for 376 years.

I assumed, as I think most people who have written about van Langren did, that his secret had to do with the achievement he's actually remembered for: [his 1645 lunar map](https://commons.wikimedia.org/wiki/File:Langrenus_map_of_the_Moon_1645.jpg), the first comprehensive survey of the moon's craters and mountains, and the method he built around it---using the sunrise and sunset lines crossing named lunar peaks as a celestial clock, visible wherever the moon was. It was a reasonable guess, and it made a good (his)story. It was also wrong.
...
Eleven years after our paper---long enough that I had filed the cryptogram away as a loose end nobody would ever tie off---I learned that it had been solved. Not by a historian of science, but by a Belgian warehouse worker and amateur cryptographer who loved a good puzzle.

The cipher had been kept alive by other amateurs: the cryptology blogger Klaus Schmeh flagged it in 2015 as a neglected historical puzzle, and the mathematician [Dirk Huylebrouck](https://dirkhuylebrouck.be/) spent years shopping it around online forums, without success. Then, in December 2020, a trio of codebreakers---David Oranchak, Sam Blake, and Jarl Van Eycke---cracked the [Zodiac Killer's notorious Z340 cipher](https://arxiv.org/pdf/2403.17350),[^zodiac] unsolved for 51 years. Huylebrouck read the news, tracked down Van Eycke, and handed him the _van Langren Code_.

[^zodiac]: The Zodiac Killer is one of the most infamous unsolved mysteries in American criminal history.
In the San Francisco Bay Area in 1968--1969, this unknown murderer killed at least five people.
Seeking public attention, he sent cryptic ciphers to newspapers and taunted police with letters
describing his acts. Van Eycke's solution was hailed as a breakthrough in amateur cryptographic circles.
...
The full R code reproducing all four steps is on GitHub: [`decode-cipher.R`](https://github.com/friendly/vanLangren-Secret/blob/master/R/decode-cipher.R).
